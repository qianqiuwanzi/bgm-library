...
def add_bgm(input_video, output_video, bgm_path, volume=0.3, fade_in=2.0, fade_out=3.0):
...
def main():
    ...
    parser.add_argument('--volume', type=float, default=0.3, help='BGM 音量 (0.0-1.0)')
