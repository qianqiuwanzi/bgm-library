---
name: bgm-library
description: 免版权 BGM 背景音乐库技能。为视频/音频项目添加高质量免版权背景音乐，支持自动混音、音量控制、淡入淡出。触发词：加背景音乐、BGM、免版权音乐、background music、royalty free music、视频配乐。适用场景：短视频制作、企业宣传片、Vlog、在线课程、产品演示。技能包含 25 首精选免版权 BGM（分 5 种风格），基于 Fesliyan Studios 素材库，可商用无需署名。
---
...
素材库位于 `assets/music-library/`，包含 25 首精选免版权 BGM：
...
所有 BGM 来自 **Fesliyan Studios**（Royalty Free，可商用，无需署名）：
- 网站：https://www.fesliyanstudios.com/
- 授权：Royalty Free Music License（可商用，无需署名）
